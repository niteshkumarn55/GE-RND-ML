...
class CsvToDataFrame():
    ...
    def get_df_from_csv(self):
        ...
        """
        csv_path = os.path.join(self.file_path._BASE_DOC_PATH, self.csv_value._GE_SEGMENT_CSV) #This the csv path of GE
        ...
        try:
            ...
            df = df[df['domain_name'].notnull()] #Just picking rows which has no NaN in domain_name
            return df
